...
<body id="page-top">
  ...
  <section id="bandas" class="portfolio-mf sect-pt4 route">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box">
            <img src="<?php echo assetsurl ?>/img/morada.png"></img>
          </div>
        </div>
        <div class="col-md-6">
          <div class="box">
      ...
      <div class="row" id="programacao_content">
        <div class="col-md-12">
          ...
          <p class="lead">
            ...
            17:30 - 19:00 - Intervalo Janta – Soaking Room - Sala Profética <br/>
            <br/>
            SESSÃO 2<br/>
            19:00 - 22:00<br/>
  ...
  <!--/ Section Local Init /-->
  <section id="local" class="paralax-mf footer-paralax bg-image route" style="background-image: url(img/banner.jpg)">
    <div class="overlay-mf"></div>
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            <h4 class="title-a light fontGlobal">Confira o que rolou no Diflen Global 2018</h4>
            <div class="line-mf"></div>
          </div>
        </div>
      </div>
